...
##################################################################
#´The decay list contains the learning deacys that will be tested#
##################################################################

decayList = [0, 0.0001, 0.00001, 0.000001]
...
for architecture in modelList:
	if architecture == "VGG":
		...
		learn = 0.00005
		filepath = "weightsVGG/weights.{epoch: 02d} - {val_acc: .2f}.hdf5"
	elif architecture == "DenseNet":
		fileName = 'DenseNet_Decay'
		file = open(fileName + '_stats.txt', 'w')
		learn = 0.00002
