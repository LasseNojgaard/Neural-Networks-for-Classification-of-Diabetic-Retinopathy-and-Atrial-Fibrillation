...
#################################################################################################################
#layerList contains the amount of layers that will be trained, the number of layers are given by 23-LayerList[i]#
#################################################################################################################
layerList = [20, 17, 12, 0]

for layers in layerList:
    file = open(fileName + format(23-layers) + '_stats.txt', 'w')
    learn = 0.00005
    decay = 0
    opti = 'RMS'
    ...
    model.save(fileName + format(23-layers) + '.h5')
    scores = model.evaluate_generator(test_generator, steps=test_data_size / test_batch_size)


    file.write('Number of Layers:' + format(23-layers))
    ...
    plt.savefig(fileName + '_' + format(23-layers) + '_CM.png', bbox_inches='tight')
    plt.clf()
