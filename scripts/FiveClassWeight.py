...
#fileName = 'DENSENET201Weights'
fileName = 'VGG16Weights'
batch_size = 128
test_batch_size = 128
...
train_generator = train_datagen.flow_from_directory(
        ...
        '/media/lnoejgaard/DataStorage/RetinaBilleder/TrainResized',
...
for learn in learningRates:
    ...
    history = model.fit_generator(train_generator, steps_per_epoch=train_data_size/batch_size, epochs=epochs, class_weight=class_weights, validation_data=validation_generator, validation_steps=val_data_size/batch_size, use_multiprocessing=True, workers=25)
