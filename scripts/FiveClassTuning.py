...
################################################
#The hyperparameters that are going to be tuned#
################################################

learningRates = [0.0005, 0.0001, 0.00005, 0.00001]
learningDecays = [0, 0.001, 0.0001, 0.00001]
optimizer = ['adam', 'RMS', 'SGD']


#fileName = 'DENSENET_Tuning_Decay_Test'
fileName = 'VGG16_Tuning_Decay_Test'
file = open(fileName + '_stats.txt', 'w')
for opti in optimizer:
    for learn in learningRates:
    	for decay in learningDecays:
            ###########################################
	        ...
	        file.write('Rate:' + format(learn) + ', Opt:'+ opti + ', Decay:'+ format(decay))
	        ...
	        file.write(', F-score:' + format(reportAvarage[2])+ '\n')
	        del history
	        del model
	        del scores
	        gc.collect()
